...
arrow(1.9, 10.2, 1.9, 9.0)
arrow(3.9, 9.9, 6.1, 8.6)

box(1.9, 8.0, 3.6, 2.0, "127篇(40.4%)\n未解决\n(系数仅图片/分子类型\n超范围/确系候选池)", fc="#fbeeee", ec="#c0392b", fontsize=8)

# Included
box(6.1, 7.5, 6.4, 2.6,
    "纳入(Included)\n初判108个模型 + 复查新增173个模型\n= 281个独立签名模型\n(34+过程主题,21癌种,21个单细胞参考数据集)", fc="#eafaf1", ec="#1e8449", fontsize=9.2)

arrow(6.1, 6.2, 6.1, 5.0)
box(6.1, 4.0, 6.4, 2.2,
    "定量分析集: 281个模型\n(2个模型因目标癌种本地无参考单细胞数据未纳入定量归因,\n仅作方法学证据留痕,不在281之列)", fontsize=8.5)
